...
struct BookTitleInfo {
    ...
    const EBibleBook enumVal = static_cast<EBibleBook>(
...
static constexpr BookTitleInfos bookTitles{
    BookTitleInfo{EBibleBook::Gen, QT_TR_NOOP("Genesis"), QT_TR_NOOP("Gen."),
                  "01_gen"},
    BookTitleInfo{EBibleBook::Ex, QT_TR_NOOP("Exodus"), QT_TR_NOOP("Ex."),
                  "02_ex"},
    BookTitleInfo{EBibleBook::Lev, QT_TR_NOOP("Leviticus"), QT_TR_NOOP("Lev."),
                  "03_lev"},
    BookTitleInfo{EBibleBook::Num, QT_TR_NOOP("Numbers"), QT_TR_NOOP("Num."),
                  "04_num"},
    BookTitleInfo{EBibleBook::Deut, QT_TR_NOOP("Deuteronomy"),
                  QT_TR_NOOP("Deut."), "05_deut"},
    BookTitleInfo{EBibleBook::Josh, QT_TR_NOOP("Joshua"), QT_TR_NOOP("Josh."),
                  "06_josh"},
    BookTitleInfo{EBibleBook::Judg, QT_TR_NOOP("Judges"), QT_TR_NOOP("Judg."),
                  "07_judg"},
    BookTitleInfo{EBibleBook::Ruth, QT_TR_NOOP("Ruth"), QT_TR_NOOP("Ruth"),
                  "08_ruth"},
    ...
    BookTitleInfo{EBibleBook::Ezra, QT_TR_NOOP("Ezra"), QT_TR_NOOP("Ezra"),
                  "15_ezra"},
    BookTitleInfo{EBibleBook::Neh, QT_TR_NOOP("Nehemiah"), QT_TR_NOOP("Neh."),
                  "16_neh"},
    BookTitleInfo{EBibleBook::Est, QT_TR_NOOP("Esther"), QT_TR_NOOP("Est."),
                  "17_est"},
    BookTitleInfo{EBibleBook::Job, QT_TR_NOOP("Job"), QT_TR_NOOP("Job"),
                  "18_job"},
    BookTitleInfo{EBibleBook::Ps, QT_TR_NOOP("Psalms"), QT_TR_NOOP("Ps."),
                  "19_ps"},
    BookTitleInfo{EBibleBook::Prov, QT_TR_NOOP("Proverbs"), QT_TR_NOOP("Prov."),
                  "20_prov"},
    ...
    BookTitleInfo{EBibleBook::Isa, QT_TR_NOOP("Isaiah"), QT_TR_NOOP("Isa."),
                  "23_isa"},
    BookTitleInfo{EBibleBook::Jer, QT_TR_NOOP("Jeremiah"), QT_TR_NOOP("Jer."),
                  "24_jer"},
    BookTitleInfo{EBibleBook::Lam, QT_TR_NOOP("Lamentations"),
                  QT_TR_NOOP("Lam."), "25_lam"},
    BookTitleInfo{EBibleBook::Ezek, QT_TR_NOOP("Ezekiel"), QT_TR_NOOP("Ezek."),
                  "26_ezek"},
    BookTitleInfo{EBibleBook::Dan, QT_TR_NOOP("Daniel"), QT_TR_NOOP("Dan."),
                  "27_dan"},
    BookTitleInfo{EBibleBook::Hos, QT_TR_NOOP("Hosea"), QT_TR_NOOP("Hos."),
                  "28_hos"},
    BookTitleInfo{EBibleBook::Joel, QT_TR_NOOP("Joel"), QT_TR_NOOP("Joel"),
                  "29_joel"},
    BookTitleInfo{EBibleBook::Amos, QT_TR_NOOP("Amos"), QT_TR_NOOP("Amos"),
                  "30_amos"},
    BookTitleInfo{EBibleBook::Obad, QT_TR_NOOP("Obadiah"), QT_TR_NOOP("Obad."),
                  "31_obad"},
    BookTitleInfo{EBibleBook::Jonah, QT_TR_NOOP("Jonah"), QT_TR_NOOP("Jonah"),
                  "32_jonah"},
    BookTitleInfo{EBibleBook::Mic, QT_TR_NOOP("Micah"), QT_TR_NOOP("Mic."),
                  "33_mic"},
    BookTitleInfo{EBibleBook::Nah, QT_TR_NOOP("Nahum"), QT_TR_NOOP("Nah."),
                  "34_nah"},
    BookTitleInfo{EBibleBook::Hab, QT_TR_NOOP("Habakkuk"), QT_TR_NOOP("Hab."),
                  "35_hab"},
    BookTitleInfo{EBibleBook::Zeph, QT_TR_NOOP("Zephaniah"),
                  QT_TR_NOOP("Zeph."), "36_zeph"},
    BookTitleInfo{EBibleBook::Hag, QT_TR_NOOP("Haggai"), QT_TR_NOOP("Hag."),
                  "37_hag"},
    BookTitleInfo{EBibleBook::Zech, QT_TR_NOOP("Zechariah"),
                  QT_TR_NOOP("Zech."), "38_zech"},
    BookTitleInfo{EBibleBook::Mal, QT_TR_NOOP("Malachi"), QT_TR_NOOP("Mal."),
                  "39_mal"},
    BookTitleInfo{EBibleBook::Matt, QT_TR_NOOP("Matthew"), QT_TR_NOOP("Matt."),
                  "40_matt"},
    BookTitleInfo{EBibleBook::Mark, QT_TR_NOOP("Mark"), QT_TR_NOOP("Mark"),
                  "41_mark"},
    BookTitleInfo{EBibleBook::Luke, QT_TR_NOOP("Luke"), QT_TR_NOOP("Luke"),
                  "42_luke"},
    BookTitleInfo{EBibleBook::John, QT_TR_NOOP("John"), QT_TR_NOOP("John"),
                  "43_john"},
    BookTitleInfo{EBibleBook::Acts, QT_TR_NOOP("Acts"), QT_TR_NOOP("Acts"),
                  "44_acts"},
    BookTitleInfo{EBibleBook::Rom, QT_TR_NOOP("Romans"), QT_TR_NOOP("Rom."),
                  "45_rom"},
    ...
    BookTitleInfo{EBibleBook::Gal, QT_TR_NOOP("Galatians"), QT_TR_NOOP("Gal."),
                  "48_gal"},
    BookTitleInfo{EBibleBook::Eph, QT_TR_NOOP("Ephesians"), QT_TR_NOOP("Eph."),
                  "49_eph"},
    BookTitleInfo{EBibleBook::Phil, QT_TR_NOOP("Philippians"),
                  QT_TR_NOOP("Phil."), "50_phil"},
    BookTitleInfo{EBibleBook::Col, QT_TR_NOOP("Colossians"), QT_TR_NOOP("Col."),
                  "51_col"},
    ...
    BookTitleInfo{EBibleBook::Titus, QT_TR_NOOP("Titus"), QT_TR_NOOP("Titus"),
                  "56_titus"},
    BookTitleInfo{EBibleBook::Philem, QT_TR_NOOP("Philemon"),
                  QT_TR_NOOP("Philem."), "57_philem"},
    BookTitleInfo{EBibleBook::Heb, QT_TR_NOOP("Hebrews"), QT_TR_NOOP("Heb."),
                  "58_heb"},
    BookTitleInfo{EBibleBook::James, QT_TR_NOOP("James"), QT_TR_NOOP("James"),
                  "59_james"},
    ...
    BookTitleInfo{EBibleBook::Jude, QT_TR_NOOP("Jude"), QT_TR_NOOP("Jude"),
                  "65_jude"},
    BookTitleInfo{EBibleBook::Rev, QT_TR_NOOP("Revelation"), QT_TR_NOOP("Rev."),
                  "66_rev"}};
